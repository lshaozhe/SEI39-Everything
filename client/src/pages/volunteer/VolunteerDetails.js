	...
	return (
		<>
			...
			<div className={styles.details_container}>
				...
				<div className={styles.right_container}>
					...
					<div className={styles.headerContainer}>
						...
						<Link to="/volunteers/volunteer_with_us/sign_up">
					...
					<div className={styles.rightDescriptionContainer}>
						...
						<div className={styles.description}>
							...
							<div className={styles.description_icons_container}>
								<span className={styles.details_icons_description} style={{ marginTop: "0.25vw" }}></span>
								<span className={styles.description_label}>Description</span>
							</div>
							<p className={styles.detailsText}>
								Mentoring is at the heart of what we do. Each mentor adopts a class of students and takes them on a learning journey that will build their confidence in themselves and
								their future.
								<br />
								<br />
								Adopting a class gives mentors the opportunity to develop their own cross-cultural facilitation and presentation skills, leading a group of women from India, Indonesia,
								Myanmar, the Philippines and Sri Lanka. It’s an opportunity to join an exciting and positive community of mentors and students from around the world.
								<br />
								<br />
								We ask our mentors to commit to adopting a class for 6 months. This will allow you to build rapport with each of your students. As they grow comfortable with your
								guidance, they will be able to open up and be more willing to share their experiences with you and their classmates.
							</p>
							{/* container keeps icon in line with label */}
							<div className={styles.description_icons_container}>
								<span className={styles.details_icons_support}></span>
								<span className={styles.description_label}>Support & resources provided</span>
							</div>
							<p className={styles.detailsText}>
								• All new mentors will be assigned a mentor buddy to learn and receive support from
								<br />
								• Class materials will be provided for each class. Learn more about the courses you could mentor here
								<br />• Aidha understands that from time to time, volunteers may need to miss a class due to work or unexpected family commitments. Fortunately, we have a strong
								volunteer support network that can provide substitutes
							</p>
						</div>
						...
						<div className={styles.courseDates}>
							...
							<div className={styles.description_icons_container}>
								...
								<span className={styles.description_label}>Upcoming Course Dates</span>
							</div>
							<p className={styles.detailsText}>
			...
			<div className={styles.carousel_container}>
				...
				<Carousel responsive={responsive} infinite className={styles.courses_carousel} transitionDuration={500}>
					{/* first carousel item */}
					<div className={styles.content}>
						...
						<div className={styles.content_button}>
							...
							<p>• Experience with Events Management or Business Development preferred</p>
							{/* container sets icons in-line with label */}
							<div className={styles.roles_icons_container}>
							...
							<p style={{ marginLeft: "7.5vw" }}>• Help us organise our annual fundraising events</p>
							<p style={{ marginLeft: "7.5vw" }}>• Propose your own fundraising initiative</p>
							<p style={{ marginLeft: "7.5vw" }}>• Connect us with potential fundraising partners</p>
					...
					<div className={styles.content}>
						...
						<div className={styles.content_button}>
							...
							<p>• Adopt a class and help students improve practical IT skills on computer and phone</p>
					...
					<div className={styles.content}>
						...
						<div className={styles.content_button}>
							...
							<p>• Adopt a class and help students build confidence in speaking, reading and writing in English</p>
					...
					<div className={styles.content}>
						...
						<div className={styles.content_button}>
							...
							<p>• Adopt a class and support students in any technical issues they may encounter during lessons</p>
