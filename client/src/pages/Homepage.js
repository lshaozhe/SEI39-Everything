		...
		<>
			<div className="page_container">
				...
				<div className="page_header">
					<span>Shows which page you are currently on *to be removed from homepage*</span>
				</div>
				...
				<CCarousel indicators className="banner_container" transition="crossfade">
					...
					<CCarouselItem>
						...
						<CCarouselCaption className="d-none d-md-block banner_label">
							<span>Aidha helps migrant domestic workers achieve economic independence through financial education.</span>
						</CCarouselCaption>
					</CCarouselItem>
			...
			<div className="content_container">
				...
				<div className="content_box" style={{ marginTop: "3vh" }}>
					...
					<Link to="/students/stories" className="content_link">
					...
					<Link to="/students/courses" className="content_link">
						<div className="content">
							<div className="content_image">
