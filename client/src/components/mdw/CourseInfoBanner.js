		...
		<>
			<div className="page_container">
				...
				<div className="page_header">
					<span>For Students / Courses / Free Courses / Financial Education</span>
				</div>
				{/* carousel for banner image, transitions between 3 different images */}
				<CCarousel className="banner_container" interval="false">
					{/* first carousel image */}
					<CCarouselItem>
						<CImage className={("d-block w-100", styles.banner)} src={banner} alt="slide 1" />
						{/* caption for first image with orange background */}
						<CCarouselCaption className={("d-none d-md-block banner_label", styles.banner_label)}>
				...
				<div className={styles.goals_box} style={{ marginTop: "3vh" }}>
					...
					<div className={styles.goals}>
						...
						<div className={styles.goals_label}>
							<div>Identify future goals and learn how to save and plan for them</div>
						</div>
					</div>
					<div className={styles.goals}>
						<div className={styles.goals_icons}>
					...
					<div className={styles.goals}>
						...
						<div className={styles.goals_label}>
							<div>Explore day-to-day spending and understand how decision-making affects your future</div>
						</div>
					</div>
					<div className={styles.goals}>
						<div className={styles.goals_icons}>
