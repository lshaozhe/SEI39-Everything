...
On your computer, create a directory in `sei-##-homework/u1/d4` with your name. e.g. `sei-##-homework/u1/d4/your_name`
...
1. A spaceship with a hull, laser blasters, tractor beam, and warp drive.
1. A list of student names from our class.
1. A list of student names from our class, each with a location.
1. A list of student names from our class, each with a location and each with a list of favorite tv shows.
...
1. Write code that will access "blue" from the rainbow array.
1. Make an object that is called your name and holds the information about your favorite food, a hobby, the name of the town that you live in currently, and your favorite datatype.
1. Write code that will access your hobby from the object that you just created.
...
1. "Pretty pretty prettayyyyy good"
1. "Swearing at Larry and Jeff"
1. "Chicken Teriyaki Boyyyyyy"
1. The object the contains the name `funkhauser`
1. Add the quote "I'm trying to elevate small talk to medium talk" to Larry's quote array. Confirm that it was added.
