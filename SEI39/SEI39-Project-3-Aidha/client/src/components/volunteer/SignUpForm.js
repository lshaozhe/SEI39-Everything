...
const SignUpForm = (props) => {
	...
	const handleFormSubmission = () => {
		...
		if (
			...
			fetchPost("http://127.0.0.1:5001/api/volunteer", "POST", convertedFormData);
		} else {
			window.alert("Kindly ensure all required fields are completed before submission.");
		}
			...
			<div className={styles.formContainer}>
				...
				<div className={styles.formField}>
					<FormControl sx={{ width: "24vw", backgroundColor: "#eee7df" }}>
						<InputLabel id="languages-spoken" sx={{ fontWeight: "bold", color: "#3c3d3c" }}>
							Languages spoken
						</InputLabel>
						<Select
				...
				<div className={styles.formFieldHTMLInput}>
					...
					<input className={styles.dateInput} required type="date" id="start-date" name="start-date" value={startDate} onChange={handleStartDateUpdate} />
				</div>
				{/* Field: End date */}
				<div className={styles.formFieldHTMLInput}>
					...
					<input className={styles.dateInput} required type="date" id="end-date" name="end-date" value={endDate} onChange={handleEndDateUpdate} />
				</div>
				{/* Field: How would you like to help Aidha? */}
				<div className={styles.formFieldHTMLTextarea}>
					<label style={{ marginTop: "1vw", marginLeft: "1vw" }} htmlFor="how-to-help">
				...
				<div className={styles.formFieldHTMLTextarea}>
					<label style={{ marginTop: "1vw", marginLeft: "1vw" }} htmlFor="learnt-about">
				...
				<div className={styles.formFieldHTMLTextarea}>
					<label style={{ marginTop: "1vw", marginLeft: "1vw" }} htmlFor="questions">
				...
				<div className={styles.checkboxAndButtonSection}>
					...
					<div>
						<button className={styles.submitButton} type="submit" onClick={handleFormSubmission}>
							Submit
						</button>
					</div>
				</div>
