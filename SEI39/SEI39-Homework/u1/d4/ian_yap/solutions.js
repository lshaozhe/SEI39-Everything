...
// => datatype: string
// => data structure example: const emailAddress = "";
//
// 3. A spaceship with a hull, laser blasters, tractor beam, and warp drive.
// => datatype: array
// => data structure example: const array = [];
//
...
// 3. console.log(crazyObject.larry.characters[2].favouriteHobby);
// 4. console.log(crazyObject.larry.nicknames[1]);
// 5. console.log(crazyObject.larry.characters[1]);
// 6. crazyObject.larry.quotes.push(
