...
// favMovies.shift(); //removing elements from the start of the array
// console.log(favMovies);
...
// favMovies.splice(15, 1, "Avatar"); //yes it permanently changes the array
// console.log(favMovies);
...
// console.log(favMovies.slice(10, 20)); //it does not permanently change the array
// console.log(favMovies);
// //store the value of your slice in a variable, console.log it - Thought question: what is going on here?
// const slicedMovies = favMovies.slice(10, 20); //assigning the last half of the elements in the array into the slicedMovies variable, where you can access in the future.
// console.log(slicedMovies);
// console.log(favMovies);
// //After running the above tasks, console.log the index of "Fast and Furious"
// console.log(favMovies.indexOf("Fast and Furious")); //we did not remove from the array.
// console.log(favMovies.indexOf("funny movie")); //we get -1 as it is not in the array.
