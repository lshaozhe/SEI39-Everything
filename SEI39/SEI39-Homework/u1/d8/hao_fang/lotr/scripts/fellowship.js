...
const leaveTheShire = () => {
  ...
  console.log(document.querySelector("#The-Shire").children[1]);
};
...
const beautifulStranger = () => {
  ...
  let strider = document.querySelector("aside").children[0].children[3];
...
const theBalrog = () => {
  ...
  let gandalf =
    document.querySelector("#the-fellowship").children[2].children[0];
...
const hornOfGondor = () => {
  ...
  let Boromir =
    document.querySelector("#the-fellowship").children[2].children[4];
...
const thereAndBackAgain = () => {
  ...
  document
    ...
    .append(document.querySelectorAll(".hobbit")[0]);
  document
    .querySelector("#The-Shire")
    .append(document.querySelectorAll(".hobbit")[1]);
};
