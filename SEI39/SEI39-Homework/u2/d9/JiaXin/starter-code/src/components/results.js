...
const results = [
  ...
  },
  {
    ...
    show: {
      ...
      image: {
        medium:
          "http://static.tvmaze.com/uploads/images/medium_portrait/141/354343.jpg",
        original:
          "http://static.tvmaze.com/uploads/images/original_untouched/141/354343.jpg",
      },
      summary:
  ...
  },
  {
    ...
    show: {
      ...
      image: {
        medium:
          "http://static.tvmaze.com/uploads/images/medium_portrait/17/44896.jpg",
        original:
          "http://static.tvmaze.com/uploads/images/original_untouched/17/44896.jpg",
      },
      summary:
...
// const data = results[0].show.image.medium;
// console.log(results[0].show.image.medium);
//console.log(results[0].show.name);
