...
So far, you've been working on the `front end`, you've been building things with _HTML_, _CSS_ and JavaScript that appear in a browser.
...
These three :three: lines of code are doing a lot!
...
You can't run two :two: servers on the same port and you can get annoying errors if you don't shut your servers down properly. Get in the habit of `control c` to shut your server down when you are done working.
