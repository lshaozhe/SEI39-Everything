...
1. have app listen on port 5000
    - once it's listening, log "Hello, Seattle.  I'm listening..."
1. test it by going to http://localhost:5000
...
1. test the `/frasier` route by going to http://localhost:5000/frasier
...
1. test the /niles route by going to http://localhost:5000/niles
1. create a GET route for `/daphne`
    - it should send a response of "Well, have fun.  I'm off to stick my head in the oven."
1. test the `/daphne` route by going to http://localhost:5000/daphne
...
1. test the `/roz` route by going to http://localhost:5000/roz
...
1. test the `/martin` route by going to http://localhost:5000/martin
...
1. test the `/Scrappy` route by going to...
  - http://localhost:5000/scrappy - what happened?
  - http://localhost:5000/Scrappy - what happened?
