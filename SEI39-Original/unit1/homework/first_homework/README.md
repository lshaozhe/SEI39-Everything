...
1. Answer the questions, write some code and submit the files via email to `damien.teokoksiong@generalassemb.ly`.

Note: there are **5 Sections** in this homework
Note: Gmail throws an error when sending certain types files, see if you can resolve the issue.
...
1. The bash file should just be the commands you ran, copy and pasted into the file. A template is provided in the file `first_hw_bash_instructions.bash`, you can copy and paste that into your file and add your commands below each comment


## Submission Guidelines

- Must be submitted before the next class day, (ie no later than 9 AM) - if you have problems submitting reach out ~15 minutes before the start of class
- Tonight we'll be submitting via email, since we don't have our github set up completely. See instructions below
...
1. Don't worry about getting it 'wrong' - you'll be graded on your reasoning, not if your ultimate answer is correct.
...
1. The first part of the control panel is:
1. The second part of the control panel is:
1. The third part of the control panel is:
