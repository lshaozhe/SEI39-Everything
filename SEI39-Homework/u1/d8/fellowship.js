...
const makeHobbits = () => {
  ...
  for (items of hobbits) {
    const hobbits = document.createElement("li");
    hobbitsList.append(hobbits);
...
const forgeTheFellowShip = () => {
  ...
  const fellowship = document.createElement("id");
...
const weWantsIt = () => {
  ...
  const gollum = document.createElement("id");
  gollum.id = "gollum";
  const mordor = document.querySelector("#Mordor");
