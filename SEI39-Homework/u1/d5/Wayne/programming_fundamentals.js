...
const f = (l) => {
  //creating an arrow function with the argument l
  ...
  while (c <= l) {
    //a while loop with a condition of c <= l
    n = c + p; //as long as condition is met, n = c + p
    [c, p] = [n, c]; //as long as condition is met, c = n, p = c
    es += c % 2 === 0 ? c : 0; //if c is an even number, then throw c into es bucket (summation)
  }
  return es;
};
...
//What would have been a more semantic name for this function - Yes instead of f I will use sumEven.
//are there any other variable names or things that would make this code easier to read and understand? - Yes we can make the name more descriptive, for e.g. "previousNum"
//which code would you rather start working with f or f2? - f2
//is this semi-colon necessary? - Yes as it closes the variable assignment "let"
