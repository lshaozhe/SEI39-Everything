...
cd ../
mv millenium_falcon ~/Desktop/death_star
...
cp storm_trooper.txt ~/Desktop/death_star/tie_fighter_2
cp storm_trooper.txt ~/Desktop/death_star/tie_fighter_3

# Move all of the `tie_fighters` out of the `death_star` and into `galaxy_far_far_away`
cd ../../death_star
mv *tie_fighter* ~/Desktop/galaxy_far_far_away
